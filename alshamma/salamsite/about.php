...
<div class="page-hero">
    <div class="container">
        ...
        <p>تعرف على معامل الشام للخبز العربي ورؤيتنا وفريقنا المتميز</p>
    ...
    <div class="container">
        <div style="display:grid;grid-template-columns:<?php echo (!empty($about['image_path']) && file_exists(__DIR__ . '/' . $about['image_path'])) ? '1fr 1.3fr' : '1fr'; ?>;gap:50px;align-items:center;">
            ...
            <div>
                ...
                <h2 style="font-size:clamp(26px,3.5vw,38px);font-weight:900;color:var(--dark);margin:10px 0 20px;line-height:1.3;"><?php echo htmlspecialchars($about['title'] ?? 'من نحن - معامل الشام للخبز العربي'); ?></h2>
    ...
    <div class="container">
        <div class="stats-grid">
            ...
            <div class="stat-item">
                ...
                <span class="stat-label">عميل موزّع</span>
            </div>
            <div class="stat-item">
    ...
    <div class="container">
        ...
        <div class="vision-mission-grid">
            <div class="vm-card">
                ...
                <h3>رؤيتنا</h3>
                <p><?php echo nl2br(htmlspecialchars($about['vision'] ?? 'أن نكون المرجع الأول في صناعة الخبز العربي الأصيل في المنطقة من حيث الجودة والطعم والموثوقية.')); ?></p>
            </div>
            <div class="vm-card">
                <div class="vm-icon"><i class="fas fa-bullseye"></i></div>
                <h3>رسالتنا</h3>
                <p><?php echo nl2br(htmlspecialchars($about['mission'] ?? 'تقديم خبز عربي طازج ومميز يومياً يجمع بين الجودة والأصالة لتحقيق رضا عملائنا.')); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="whyus-grid">
            ...
            <div class="whyus-card">
                ...
                <h4>التميز</h4>
                <p>نسعى دائماً نحو التميز في كل ما نقدمه من منتجات وخدمات للخبز العربي.</p>
            </div>
            <div class="whyus-card">
                <div class="whyus-icon"><i class="fas fa-lightbulb"></i></div>
                <h4>الابتكار</h4>
                <p>نبتكر وصفات وأصناف جديدة من الخبز العربي تواكب أذواق عملائنا وتوقعاتهم.</p>
            </div>
            <div class="whyus-card">
                <div class="whyus-icon"><i class="fas fa-leaf"></i></div>
                <h4>الاستدامة</h4>
                <p>نلتزم بالمعايير الصحية والبيئية في جميع مراحل الإنتاج والتوزيع.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="team-section" style="background:var(--gray-light);">
    <div class="container">
        <div class="section-header">
            ...
            <div class="divider"><i class="fas fa-gem"></i></div>
            <p>فريق متخصص من الخبراء والمحترفين في صناعة الخبز العربي</p>
        </div>
        <div class="team-grid">
...
<section class="cta-strip">
    <div class="container">
        ...
        <p>تواصل معنا الآن للاستفسار عن منتجاتنا وخدمات التوزيع</p>
        <div class="cta-btns">
